...
Los 9 pasos tienen video generado con OpenArt (imagen de arranque con Seedream 4.5 a partir del niño del video de PixVerse, y video de 5 s con PixVerse V6 en 720p). Cada clip se prepara con `herramientas/preparar_video.sh` (bucle ida y vuelta de 10 s, sin audio, MP4 + WebM) y la interfaz del juego va encima. La misión usa el video de DomoAI, que trae su propia interfaz dibujada: en ese caso se oculta la del juego (`VIDEOS_CON_INTERFAZ`). Detalle del proceso en `herramientas/videos_openart.md`.
